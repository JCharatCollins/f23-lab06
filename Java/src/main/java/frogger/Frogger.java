...
public class Frogger {
    ...
    String zipCode, String state, String gender) {
        ...
        id = new FroggerID(firstName, lastName, phoneNumber, zipCode, state, gender);
    }
    ...
    // Original issue: was using information entirely from road to execute methods, should have been methods on road.
